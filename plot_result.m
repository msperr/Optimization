...
%% Output Results
f_u_hst = norm(u_hst - u_hst_1,1)/norm(u_hst_1,1)
f_u_crd = norm(u_crd - u_crd_1,1)/norm(u_crd_1,1)
f_y_hst = norm(y_hst - y_hst_1,1)/norm(y_hst_1,1)
f_y_crd = norm(y_crd - y_crd_1,1)/norm(y_crd_1,1)
